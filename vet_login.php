...
$sql=mysqli_query($conn,"select * from vetenary where email='$e' and password='$p'");
...
<form method="post">
	<div class="row">
		...
		<div class="col-sm-4"><h2>Vetenary Login Form</h2></div>
	</div>
	...
	<div class="row" style="margin-top:10px">
		...
		<div class="col-sm-5">
		<input type="email" name="e" value="<?php echo @$e;?>" class="form-control"/></div>
	</div>
