...
$user= $_SESSION['vetenary'];
if($user=="")
{header('location:../index.php');}
$sql=mysqli_query($conn,"select * from vetenary where email='$user' ");
...
<html lang="en">
  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
			...
			<?php 
			$q=mysqli_query($conn,"select image from user where email='".$_SESSION['vetenary']."'");
      ...
      <li><a href="index.php?page=view_message"><span class="glyphicon glyphicon-envelope"></span> View Message</a></li>	
