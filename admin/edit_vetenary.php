<?php
	...
	mysqli_query($conn,"update vetenary set Name='$n',designation	='$desg',mobile='$mob',	password='$pass' where id='".$_GET['id']."'");	

$err="<font color='green'>Vetenary Details updated</font>";

	}

$con=mysqli_query($conn,"select * from vetenary where id='".$_GET['id']."'");
...
<h1 class="page-header">Update  Vet</h1>
