...
$sql=mysqli_query($conn,"select * from farmer where email='$user' ");
...
<html lang="en">
  <head>
    ...
    <title>Poultry Advisory System</title>
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
			...
			<?php 
			$q=mysqli_query($conn,"select image from farmer where email='".$_SESSION['farmer']."'");
			...
			{
			?>
			<li><a href="#"><img style="border-radius:50px" src="../images/<?php echo $_SESSION['farmer'];?>/<?php echo $row['image'];?>" width="100" height="100" alt="not found"/></a></li>
			<?php 
			}
			?>
			
      <li><a href="index.php?page=send_message"><span class="glyphicon glyphicon-inbox"></span> Send Message</a></li>
      <li><a href="index.php?page=view_feedback"><span class="glyphicon glyphicon-comment"></span> View Feedback</a></li>
