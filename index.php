...
<body>
    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="background:#66CCFF">
        <div class="container" >
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php" style="color:#FFFFFF">Poultry Advisory System</a>
	...
	<li class="dropdown">
        ...
        <ul class="dropdown-menu">
          ...
          <li><a href="index.php?info=login">Farmer</a></li>
		  <li><a href="index.php?info=vet_login">Veterinary</a></li> 
...
<?php 
					...
					if($info!="")
					{
						 ...
						 include('login.php');
						  ...
						  else if($info=="vet_login")
						 {
						 include('vet_login.php');
						 }
    ...
    <header id="myCarousel" class="carousel slide">
        ...
        <div class="carousel-inner">
            <div class="item active">
                ...
                <div class="fill" style="background-image:url('images/hm11.jpg');"></div>
            ...
            <div class="item">
                <div class="fill" style="background-image:url('images/hm2.jpg');"></div>
                <div class="carousel-caption">
...
<!-- slider -->			
	...
	<div class="navbar-fixed-bottom nav navbar-inverse text-center" style="padding:15px;height:40px; background:#66CCFF">
		<span style="color:#FFFFFF">Designed and Developed By <a href="">Angela</a> </span>
	</div>
    <!-- jQuery -->
